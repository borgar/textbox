import { Token, Break, LineBreak } from './tokens.js';
import { textparser } from './textparser.js';
import { htmlEntitites } from './htmlentities.js';
const re_whitespace = /^[\n\r\x20\u2000-\u200B\u205F\u3000]/;
...
/** @type {Record<string, (p: object) => void>} */
const tag_to_prop = {
  b: p => (p.weight = 700),
...
export function htmlparser (text) {
  ...
  /** @type {Record<string, null|string|boolean>} */
  let prop = {
    weight: null,
    style: null,
    sub: false,
